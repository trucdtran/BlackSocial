...
import com.chaupha.blacksocial.adapters.PostsByUserAdapter;
import com.chaupha.blacksocial.dialogs.UnfollowConfirmationDialog;
...
import com.chaupha.blacksocial.main.post.createPost.CreatePostActivity;
import com.chaupha.blacksocial.main.postDetails.PostDetailsActivity;
import com.chaupha.blacksocial.main.usersList.UsersListActivity;
import com.chaupha.blacksocial.main.usersList.UsersListType;
...
import com.chaupha.blacksocial.utils.LogoutHelper;
...
public class ProfileActivity extends BaseActivity<ProfileView, ProfilePresenter> implements ProfileView, GoogleApiClient.OnConnectionFailedListener, UnfollowConfirmationDialog.Callback {
    ...
    public void setProfilePhoto(String photoUrl) {
        ImageUtil.loadImage(this, new RequestOptions(), photoUrl, imageView, new RequestListener<Drawable>() {
            @Override
