...
import com.chaupha.blacksocial.managers.listeners.*;
...
import com.chaupha.blacksocial.utils.*;
...
public class PostManager extends FirebaseListenersManager {
    ...
    public void loadImageMediumSize(String imageTitle, ImageView imageView, @Nullable OnImageRequestListener onImageRequestListener) {
        ...
        ImageUtil.loadMediumImageCenterCrop(context, new RequestOptions(), mediumStorageRef, originalStorageRef, imageView, width, height, new RequestListener<Drawable>() {
            @Override
    ...
    public void loadImageMediumSize(String imageTitle, ImageView imageView) {
        loadImageMediumSize(imageTitle, imageView, null);
    }
